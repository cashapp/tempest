...
class DynamoDbAsyncViewWithResultTest {
  ...
  private val versionedAttributeTable by lazy {
    db.asyncLogicalDb<AsyncVersionedAttributeDb>(
      defaultExtensions() + autoGeneratedTimestampRecordExtension + TempestAutoGeneratedTimestampRecordExtension.create(
        fakeClock
  ...
  fun parallelSaveWithResult() = runBlocking(multiThreadedCoroutineDispatcher) {
      ...
      async {
        ...
        val two = versionedAttributeTable.parallelAttributes.saveWithResult(
          one.copy(
            ...
            one_created_at = one.created_at_instant!!,
            one_updated_at = one.updated_at_instant!!,
          )
        )
        ...
        val three = versionedAttributeTable.parallelAttributes.saveWithResult(
          two.copy(
            ...
            two_created_at = two.created_at_instant!!,
            two_updated_at = two.updated_at_instant!!,
          )
        )
        ...
        val four = versionedAttributeTable.parallelAttributes.saveWithResult(
          three.copy(
            ...
            three_created_at = three.created_at_instant!!,
            three_updated_at = three.updated_at_instant!!,
          )
        )
        ...
        val five = versionedAttributeTable.parallelAttributes.saveWithResult(
          four.copy(
            ...
            four_created_at = four.created_at_instant!!,
            four_updated_at = four.updated_at_instant!!,
          )
        )
    ...
    items.forEach {
      ...
      if (expectedVersion == 1L) {
        // No updates. CreatedAt and UpdatedAt should match with Tempest extension
        ...
        seenUpdatedAts.add(it.updated_at_instant!!)
      ...
      if (expectedVersion >= 2L) {
        // all other version should have updated_at_instant before the current version
        // and created_at_instant equal to the latest.
        assertThat(descriptionParts[1]).isEqualTo(1)
        assertThat(it.one_version).isEqualTo(1)
        assertThat(it.one_created_at).isEqualTo(it.created_at_instant)
        assertThat(it.one_updated_at).isEqualTo(it.one_created_at)
        assertThat(it.one_updated_at).isBefore(it.updated_at_instant)
        seenUpdatedAts.add(it.one_updated_at!!)
      }

      if (expectedVersion >= 3L) {
        // version n should have updated_at_instant after version n-1
        assertThat(descriptionParts[2]).isEqualTo(2)
        assertThat(it.two_version).isEqualTo(2)
        assertThat(it.two_created_at).isEqualTo(it.created_at_instant)
        assertThat(it.two_updated_at).isBefore(it.updated_at_instant)
      ...
      if (expectedVersion >= 4L) {
        ...
        assertThat(it.three_created_at).isEqualTo(it.created_at_instant)
        assertThat(it.three_updated_at).isBefore(it.updated_at_instant)
      ...
      if (expectedVersion == 5L) {
        ...
        assertThat(it.four_created_at).isEqualTo(it.created_at_instant)
        assertThat(it.four_updated_at).isBefore(it.updated_at_instant)
  ...
  @Test
  fun createdAtNotUpdatedWithoutExtension() = runBlockingTest {
    val item = VersionedAttribute(
      partition_key = "item_one",
      description = "one of the items",
    )
