...
class SchemaTest {
  ...
  fun badKeyType() {
    ...
    }.withMessage("Expect class app.cash.tempest2.internal.BadIndexOffset1 to have property album_token")

    assertThatIllegalArgumentException().isThrownBy {
      musicDb.music.secondaryIndex(BadIndexOffset2::class, AlbumInfo::class)
    }.withMessage("Expect class app.cash.tempest2.internal.BadIndexOffset2 to have property sort_key")

    assertThatIllegalArgumentException().isThrownBy {
      musicDb.music.secondaryIndex(BadIndexOffset3::class, AlbumInfo::class)
    }.withMessage("Expect the return type of class app.cash.tempest2.internal.BadIndexOffset3.artist_name to be kotlin.String but was kotlin.Int")
    ...
    }.withMessage("Expect class app.cash.tempest2.musiclibrary.MusicItem to have secondary index nonexistent_index_name")

    assertThatIllegalArgumentException().isThrownBy {
      musicDb.music.secondaryIndex(BadIndexOffset6::class, AlbumInfo::class)
    }.withMessage("Please move Attribute annotation from class app.cash.tempest2.internal.BadIndexOffset6.sort_key to class app.cash.tempest2.musiclibrary.AlbumInfo.sort_key")

    assertThatIllegalArgumentException().isThrownBy {
      musicDb.music.secondaryIndex(BadIndexOffset7::class, AlbumInfo::class)
    }.withMessage("class app.cash.tempest2.internal.BadIndexOffset7 must have a constructor")
  }
  ...
  fun badItemType() {
    ...
    }.withMessage("Expect class app.cash.tempest2.internal.BadItem1 to map to class app.cash.tempest2.musiclibrary.MusicItem's hash key partition_key")

    assertThatIllegalArgumentException().isThrownBy {
      musicDb.music.inlineView(Any::class, BadItem2::class)
    }.withMessage("Expect class app.cash.tempest2.internal.BadItem2 to map to class app.cash.tempest2.musiclibrary.MusicItem's range key sort_key")
    ...
    }.withMessage("Expect the return type of class app.cash.tempest2.internal.BadItem4.album_title to be kotlin.String but was kotlin.Int")
    ...
    }.withMessage("Expect class app.cash.tempest2.internal.BadItem6.sort_key to be annotated with a prefix")

    assertThatIllegalArgumentException().isThrownBy {
      musicDb.music.inlineView(Any::class, BadItem7::class)
    }.withMessage("class app.cash.tempest2.internal.BadItem7 must have a constructor")
