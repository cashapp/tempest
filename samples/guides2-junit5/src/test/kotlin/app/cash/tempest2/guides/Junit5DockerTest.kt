...
import app.cash.tempest2.musiclibrary.AlbumInfo as AlbumInfo1

class Junit5DockerTest {
  @RegisterExtension
  @JvmField
  val db = TestDynamoDb.Builder(DockerDynamoDbServer.Factory)
